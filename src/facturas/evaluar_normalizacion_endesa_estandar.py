"""Evaluacion independiente de Endesa procesada por la ruta estandar."""
...
RUTA_BASE = (
    RAIZ
    / "pruebas/facturas/resultados/openai/muestra_completa/documento_05"
    / "comparacion_patron.json"
)
RUTA_NORMALIZADA = (
    RAIZ
    / "pruebas/facturas/resultados/openai/normalizacion_endesa_estandar"
...
def evaluar() -> tuple[Path, Path]:
    ...
    lineas = [
        "# Evaluacion independiente de Endesa por la ruta estandar",
        "",
