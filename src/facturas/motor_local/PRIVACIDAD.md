...
El shadow está desactivado por defecto. Cuando se habilita expresamente, su salida es lateral, local y sin autoridad. HEFAME, FEDEFARMA y Alliance permanecen en shadow y `COFARES_LOCAL_AUTHORITY` permanece `False`. Las rutas externas existentes del programa están separadas y este paquete no las importa ni las llama.
