"""Evaluacion independiente de Pierre Fabre por la ruta estandar."""
...
RUTA_BASE = (
    RAIZ
    / "pruebas/facturas/resultados/openai/muestra_completa/documento_06"
    / "comparacion_patron.json"
)
RUTA_NORMALIZADA = (
    RAIZ
    / "pruebas/facturas/resultados/openai/normalizacion_pierre_fabre_estandar"
