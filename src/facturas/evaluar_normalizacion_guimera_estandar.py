"""Evaluacion independiente del caso Guimera procesado por la ruta estandar."""
...
RUTA_BASE = (
    ...
    / "evaluacion/general/caso_02/gpt-5.6-luna.json"
)
RUTA_NORMALIZADA = (
    RAIZ
    / "pruebas/facturas/resultados/openai/normalizacion_guimera_estandar"
...
def evaluar() -> tuple[Path, Path]:
    ...
    lineas = [
        "# Evaluacion independiente de Guimera por la ruta estandar",
        "",
